...
export async function POST(request: NextRequest) {
  ...
  settings = await prisma.checkoutSettings.update({
        ...
        data: {
          ...
          generalDonationDefaultAmount: data.generalDonationDefaultAmount,
          generalDonationPresetAmounts: data.generalDonationPresetAmounts,
          generalDonationMinAmount: data.generalDonationMinAmount,
          generalDonationMaxAmount: data.generalDonationMaxAmount,
